...
function CardLoader({ url }: PokemonSummary) {
  ...
  if (loading || !pokemon) {
    return <div className="pkm-card-skeleton h-96 bg-[length:400px_100%] motion-safe:animate-shimmer rounded-3xl border-[1.5px] border-accent-gold/15 shadow-card" />;
  }
